...
require(['masa', 'mapv', 'common/bMapSettings'], function (Masa, $mapv, bMapSettings) {
    ...
    Masa.View({
        ...
        showMap: function () {
            var that = this;
            Masa.getRequest("vistor_work_list").done(function (d) {
                ...
                that.bmap.setCenter(new BMap.Point(d.caseLocate[0], d.caseLocate[1])); // 初始化地图,设置中心点坐标和地图级别
                that.bmap.setZoom(10);
                that.mapv.setData(that.parseData(d.customerWorkLocateList));
